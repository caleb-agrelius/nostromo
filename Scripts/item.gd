...
func _ready() -> void:
	...
	match item_type:
		"Iron":
			var iron_mesh = preload("res://Assets/resource_node.obj")
			mesh_instance.mesh = iron_mesh
			_update_collision_from_mesh(iron_mesh)
			mat = preload("res://Assets/iron.tres")
		"Gold":
			var gold_mesh = preload("res://Assets/resource_node.obj")
			mesh_instance.mesh = gold_mesh
			_update_collision_from_mesh(gold_mesh)
			mat = preload("res://Assets/gold.tres")
		"Door":
			var door_mesh = preload("res://Assets/door.obj")
			mesh_instance.mesh = door_mesh
			_update_collision_from_mesh(door_mesh)
			mat = preload("res://Assets/door.tres")

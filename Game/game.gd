...
#map
@onready var open_world: PackedScene = load("res://Locations/open_world.tscn")
@onready var hideout: PackedScene = load("res://Locations/hideout_interior.tscn")
...
#items
@onready var mesh_res: Mesh = preload("res://Blends/resource_node.obj")
@onready var resource_node_shader: Shader = preload("res://shaders/resource_node.gdshader")
@onready var item_node_scene: PackedScene = preload("res://Interactables/item.tscn")
